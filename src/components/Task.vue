  ...
  <div class="task-edit" v-else>
    <form class="task-content">
      ...
      <input class="task-description" v-model="task.description" placeholder="Описание">
        ...
        <input type="date" class="task-date-content task-date-content-edit" v-model="task.date" placeholder="Date">
    </form>
  </div>
</template>
...
.task-description, .task-description-edit{
  grid-area: 2 / 1 / 3 / 6;
}
.task-description, .task-date-content, .task-description-edit{
  font-weight: 400;
  font-size: 16px;
}
.task-date{
